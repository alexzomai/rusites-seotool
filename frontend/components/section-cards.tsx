    ...
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">Посетители за последние 6 месяцев</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            Снижение на 20% за период <TrendingDownIcon className="size-4" />
          </div>
          <div className="text-muted-foreground">Требует внимания</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            Высокое удержание пользователей <TrendingUpIcon className="size-4" />
          </div>
          <div className="text-muted-foreground">Вовлечённость превышает цели</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">
            Стабильный рост показателей <TrendingUpIcon className="size-4" />
          </div>
